...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- Subscription Form -->
                                <form id="subscription-form-basic" action="{{ route('razorpay.payment') }}" method="POST" data-parsley-validate>
                                        @csrf
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="no_of_people" name="no_of_people" 
               value="{{$no_of_people}}" placeholder="Enter the number of people" 
               required min="1" max="25" 
               data-parsley-min="1" data-parsley-max="25"
               data-parsley-error-message="people must be between 1 and 25 For Basic Plan For More Contact Admin">
...
@else
    <div class="form-group">
        <label for="no_of_people">Number of People</label>
        <input type="number" class="form-control" id="no_of_people" name="no_of_people" 
               value="1" placeholder="Enter the number of people" 
               required min="1" max="25"
               data-parsley-min="1" data-parsley-max="25"
               data-parsley-error-message="Number of people must be between 1 and 25 For Basic Plan">
    </div>
@endif

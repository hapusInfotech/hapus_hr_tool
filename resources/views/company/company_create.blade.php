            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name"
                        value="{{ old('company_name') }}" required data-parsley-required-message="Company name is required.">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="company_type" class="form-label">Company Type</label>
                    <input type="text" class="form-control" id="company_type" name="company_type"
                        value="{{ old('company_type') }}" required data-parsley-required-message="Company type is required.">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="company_phone_number" name="company_phone_number"
                        value="{{ old('company_phone_number') }}" required data-parsley-required-message="Phone number is required."
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="company_address_line_2" name="company_address_line_2"
                        value="{{ old('company_address_line_2') }}"  data-parsley-required-message="Address Line 2 is required.">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="city" class="form-label">City</label>
                    <input type="text" class="form-control" id="city" name="city"
                        value="{{ old('city') }}" required data-parsley-required-message="City is required.">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="company_pincode" name="company_pincode"
                        value="{{ old('company_pincode') }}" required data-parsley-type="digits" data-parsley-required-message="Pincode is required."

...
<body>
    <div class="container-scroller">
            ...
            <ul class="nav">
                <li class="nav-item nav-profile border-bottom">
                    <a href="#" class="nav-link flex-column">
                        <div class="nav-profile-image">
                            <img src="{{ asset('company_dashboard/assets/images/faces/face1.jpg') }}" alt="profile" />
                ...
                <li class="nav-item pt-3">
                    <a class="nav-link d-block" href="{{ asset('company_dashboard/index.html') }}">
                        <img class="sidebar-brand-logo" src="{{ asset('company_dashboard/assets/images/logo.svg') }}"
                            alt="" />
            ...
            <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    ...
                    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                        <a class="navbar-brand brand-logo-mini" href="{{ asset('company_dashboard/index.html') }}"><img
                                src="{{ asset('company_dashboard/assets/images/logo-mini.svg') }}" alt="logo" /></a>
                    </div>
                    <ul class="navbar-nav">
        ...
        <script src="{{ asset('company_dashboard/assets/vendors/jquery-bar-rating/jquery.barrating.min.js') }}">
        </script>

                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="payment-btn">
                                <form action="/capture-payment" method="POST" id="paymentForm" class="d-flex justify-content-between">
                                    @csrf
                                    ...
                                    <button type="button" id="payBtn" class="btn btn-primary btn-block w-25">Pay Now</button>
                                    @else
                                    <!-- Show button for one-time payment -->
                                    <button type="button" id="payBtn" class="btn btn-primary btn-block w-25">Pay Now</button>
                                    @endif

                                    <button type="button" id="cancel-pay" class="btn btn-danger w-25">Cancel</button>
                                </form>
                            </div>
                        </div>
